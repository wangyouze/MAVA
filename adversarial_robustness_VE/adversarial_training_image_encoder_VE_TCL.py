...
from train.pgd_train import pgd_2, vnifgsm
...
def main(args, config):
	...
	# visual_encoder_state_dict = torch.load("/data1/wangyouze/projects/save/VE/TCL/TVT_lr_0.001_eps_2/ViT-B_16_openai_train_coco_2_test_flickr30k_l2_train_coco_2_test_flickr30k_Fsr1p/checkpoints/step_4.pt", map_location='cuda')
	# model.visual_encoder.load_state_dict(visual_encoder_state_dict, strict=False)
	...
	for epoch in tqdm(range(0, args.steps)):
		...
		if local_rank == 0:
			...
			if args.save_checkpoints:
				...
				# torch.save(model.module.visual_encoder.state_dict(), '/data1/wangyouze/projects/save/VE/TCL/TVT_lr_0.001_eps_2/ViT-B_16_openai_train_coco_2_test_flickr30k_l2_train_coco_2_test_flickr30k_Fsr1p/checkpoints/step_{epoch}.pt')
				# torch.save(optimizer.state_dict(), '/data1/wangyouze/projects/save/VE/TCL/TVT_lr_0.001_eps_2/ViT-B_16_openai_train_coco_2_test_flickr30k_l2_train_coco_2_test_flickr30k_Fsr1p/checkpoints/step_{epoch}_opt.pt')
...
def train_one_epoch(
	...
	for batch_idx, (images, texts_group, images_ids, text_ids_groups) in enumerate(dataloader):
		...
		# adv_images_neighbor, adv_images = vnifgsm(
		# 		txt2img=txt2img,
		# 		model=model,
...
if __name__ == '__main__':
	...
	args.output_dir = f'/data/home/wangyouze/projects/save/adversarial_robustness/VE/TCL/TVT_TCL_lr_{args.lr}_eps_{args.eps}_stepsize_{args.stepsize_adv}_N_{args.num_neighbor_sampling}_pgd_2'
	args.save_dir = f'/data/home/wangyouze/projects/save/adversarial_robustness/VE/TCL/TVT_TCL_lr_{args.lr}_eps_{args.eps}_stepsize_{args.stepsize_adv}_N_{args.num_neighbor_sampling}_pgd_2'
