...
class ALBEF(nn.Module):
    ...
    def forward(self, image, text, targets=None, alpha=0, train=True):
    ...
    def inference(self, image, text_input=None, use_embeds=False):
        ...
        fusion_output = self.text_encoder(encoder_embeds=text_embed,
                                          ...
                                          return_dict=True,
                                          mode='fusion')
        return {'text_embed': text_embed, 'image_embed': image_embed, 'fusion_output': fusion_output.last_hidden_state}
