...
def retrieval_eval(model, model_ad, ref_model, data_loader, tokenizer, device, config, args):
    ...
    for images, texts, texts_ids in data_loader:
        ...
        with torch.no_grad():
            ...
            output = model_ad.inference(images, texts)
...
def main(args, config):
    ...
    model_ad, preprocess = clip.load(args.image_encoder, device=device)
    ...
    # visual_encoder_state_dict = torch.load("/data/home/wangyouze/projects/save/adversarial_robustness/multiple-captions-experiments/CLIP/TVT_CLIP_lr_0.001_eps_4.0_stepsize_1.0_N_3_pgd_2_M_5_bak/ViT-B_16_train_coco_2_test_flickr30k_l2_train_coco_2_test_flickr30k_TCKCw/checkpoints/step_9.pt", map_location='cuda')
    
    # model_ad.visual.load_state_dict(visual_encoder_state_dict, strict=False)

    if args.fine_tuning:
        visual_encoder_state_dict = torch.load(args.fine_tuning_checkpoint, map_location='cuda')
        model.visual.load_state_dict(visual_encoder_state_dict, strict=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/data/home/wangyouze/projects/Co-Attack/configs/Retrieval_flickr.yaml')
    ...
    parser.add_argument('--fine_tuning_checkpoint', default='/data/home/wangyouze/projects/github/MAVA/adversarial_robustness/CLIP/save/MAVA_ITR_lr_0.001_eps_4.0_N_3_steps_10/ViT-B_16_train_coco_2_test_flickr30k_l2_train_coco_2_test_flickr30k_xxQN2/checkpoints/step_9.pt')
