...
from dataset.ve_dataset import ve_dataset_SGA, ve_dataset_SGA_2
...
def create_dataset(dataset, config):
    ...
    elif dataset=='re_test':
        test_transform = transforms.Compose([transforms.Resize((config['image_res'],config['image_res']),interpolation=Image.BICUBIC),
                                             transforms.ToTensor()])
        test_dataset = re_eval_dataset(config['test_file'], test_transform, config['image_root'])
        return test_dataset
    elif dataset=='pair':
